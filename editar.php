                   ...
                   <?php 
                    ...
                    <div class="col-sm-6 col-md-5 col-lg-4 item">
                        <div class="shadow box">
                            ...
                            <p class="text-justify description"><?php echo $dados['resumo_noticia']; ?></p><a class="learn-more btn-acessar" href="editar_noticia.php?id=<?php echo $dados['id']; ?>">Acessar notícia</a><br><p class="data-texto"><?php echo date("d/m/Y", strtotime($dados['noticia_data_postagem'])); ?></p></div>
                    </div>
                    <?php

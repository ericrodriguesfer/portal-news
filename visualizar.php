                ...
                <div class="container"><a class="navbar-brand" href="home.php">Portal News</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse"
                        ...
                        <ul class="nav navbar-nav mr-auto">
                            ...
                            <li class="nav-item" role="presentation"></li>
                        </ul><span class="navbar-text actions"> <a class="btn btn-light action-button" role="button" href="home.php">Voltar a administrar</a></span></div>
                </div>
            </nav>
        </div>
                ...
                <div class="row justify-content-center features">
                    ...
                    <div class="col-sm-6 col-md-5 col-lg-4 item">
                        <div class="shadow box">
                            ...
                            <p class="text-justify description"><?php echo $dados['resumo_noticia']; ?></p><a class="learn-more btn-acessar" href="noticia_administrador.php?id=<?php echo $dados['id']; ?>">Acessar notícia</a><br><p class="data-texto"><?php echo date("d/m/Y", strtotime($dados['noticia_data_postagem'])); ?></p></div>
                    </div>
                    <?php

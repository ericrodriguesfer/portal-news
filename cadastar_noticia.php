        ...
        <div class="footer-clean">
            <div class="row register-form">
                <div class="col-md-8 offset-md-2">
                    <form class="shadow custom-form" action="assets/php/cadastrar.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row form-group">
                            ...
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="resumo_titulo_noticia" placeholder="Digite o resumo do título da notícia" required=""></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Resumo da notícia</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="resumo_noticia" placeholder="Digite o resumo da notícia" required=""></div>
                        </div>
                        <div class="form-row form-group">
                        ...
                        <div class="form-row form-group">
                            ...
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="titulo_noticia" placeholder="Digite o título da notícia" required=""></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Citação ou trecho da notícia</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="citacao_noticia" placeholder="Digite um trecho ou citação da notícia" required=""></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Autor da notícia</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="autor_noticia" placeholder="Digite o autor da notícia" required=""></div>
                        </div>
                        <div class="form-row form-group">
                        ...
                        <div class="form-row form-group">
                            ...
                            <div class="col-sm-6 input-column"><input type="file" style="width: 360px;" name="foto_noticia" required=""></div>
                        </div>
                        <div class="form-row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Notícia</label></div>
                            <div class="col-sm-6 input-column"><textarea class="form-control" style="height: 200px;width: 360px;" name="texto_noticia" placeholder="Digite a sua notícia" required=""></textarea></div>
                        </div><button class="btn btn-light submit-button" type="subtmit">Cadastar notícia</button>
                    </form>
                </div>
            </div>
            <footer>

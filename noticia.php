    ...
    <body>
                ...
                <div class="container"><a class="navbar-brand" href="index.php">Portal News</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse"
                        ...
                        <ul class="nav navbar-nav mr-auto">
                            ...
                            <li class="nav-item" role="presentation"></li>
                        </ul><span class="navbar-text actions"> <a class="btn btn-light action-button" role="button" href="index.php">Voltar</a></span></div>
                </div>
            </nav>
        </div>
        ...
        <div class="shadow contact-clean">
            ...
            <form class="shadow" method="post">
                ...
                <hr>
                <div class="form-group">
                    <p class="lead">Agradeçemos a sua preferência pelo nosso portal de notícias.</p>
                </div>
                <hr>
                <div class="form-group text-right"><a href="index.php">Retornar a seleção de notícias</a></div>
            </form>
        </div>
